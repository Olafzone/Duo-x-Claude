...
<body style="margin: 0; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background: #fff; padding: 30px; border-radius: 8px;">
        <h1 style="margin: 0 0 20px 0; font-size: 22px; color: #000;">
            ...
            <?php else: ?>
                Nowy feedback (uniwersalna ankieta)
            <?php endif; ?>
        </h1>
        ...
        <table style="width: 100%; margin-bottom: 20px; font-size: 14px;">
            ...
            <tr>
                ...
                <td style="padding: 8px 0;"><?php echo esc_html($project->client_name); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 8px 0;"><?php echo intval($feedback_data['q6_rating']); ?>/10</td>
            </tr>
            <?php endif; ?>
        ...
        <div style="margin-bottom: 20px; padding: 15px; background: #fff8e1; border-radius: 6px;">
            <p style="margin: 0 0 5px 0; font-size: 12px; color: #f57c00; text-transform: uppercase;">Potencjalny referral!</p>
        ...
        <p style="margin: 0; font-size: 14px;">
            <a href="<?php echo esc_url(admin_url('admin.php?page=duo-feedback')); ?>" style="color: #000;">
